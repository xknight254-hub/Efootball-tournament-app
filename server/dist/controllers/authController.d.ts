...
export declare function getPreferences(req: AuthRequest, res: Response): Response<any, Record<string, any>> | undefined;
export declare function updatePreferences(req: AuthRequest, res: Response): Response<any, Record<string, any>> | undefined;
export declare function logout(req: AuthRequest, res: Response): Response<any, Record<string, any>> | undefined;
export declare function deleteAccount(req: AuthRequest, res: Response): Response<any, Record<string, any>> | undefined;
