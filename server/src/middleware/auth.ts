...
export function authenticateToken(req: AuthRequest, res: Response, next: NextFunction) {
  ...
  try {
    ...
    const user = db.prepare('SELECT id, username, email, is_admin, is_super_admin, is_organizer, telegram_id, registration_paid FROM users WHERE id = ?').get(decoded.userId) as any;
